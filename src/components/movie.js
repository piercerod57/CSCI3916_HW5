...
class Movie extends Component {
    ...
    constructor(props) {
        ...
        this.state = {genre:'Drama',rating:1,title: '',actor1:'',actor2:'',actor3:'',year:''};
    ...
    handleOnSave=(event)=>
    {
        ...
        axios.post('https://csci3916hw4.herokuapp.com/movies/get', JSON.stringify(json), {'headers':headers})
        ...
        return (
            <div>
                ...
                <div className="row actorbox">
                    ...
                    <input onChange={ (e) => this.handleOnChangeyear(e)} type="text" id="year" name="year" className="form-control actorinput" placeholder="required..."></input>
                </div>
                <div>
